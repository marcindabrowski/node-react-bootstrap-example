  ...
  describe('child <RightNavButton />', () => {
    ...
    describe('second RightNavButton', () => {
      ...
      it('should be passed props label:string set to mock value', () => {
        ...
        expect(RightNavButton.at(secondRightNavButtonIndex).prop('label')).to.equal(
          rightLinksMock[secondRightNavButtonIndex].label,
        );
      });
      ...
      it('should be passed props link:string set to mock value', () => {
        ...
        expect(RightNavButton.at(secondRightNavButtonIndex).prop('link')).to.equal(
          rightLinksMock[secondRightNavButtonIndex].link,
        );
      });
      ...
      it('should be passed props viewName:string set to mock value', () => {
        ...
        expect(RightNavButton.at(secondRightNavButtonIndex).prop('viewName')).to.equal(
          rightLinksMock[secondRightNavButtonIndex].view,
        );
      });
      ...
      it('should be passed props onClick:function to be a function', () => {
        ...
        expect(typeof RightNavButton.at(secondRightNavButtonIndex).prop('onClick')).to.equal(
          'function',
        );
      });
    });
