  ...
  describe('child <LeftNavButton />', () => {
    ...
    describe('second LeftNavButton', () => {
      ...
      it('should be passed props label:string set to mock value', () => {
        ...
        expect(LeftNavButton.at(secondLeftNavButtonIndex).prop('label')).to.equal(
          leftLinksMock[secondLeftNavButtonIndex].label,
        );
      });
      ...
      it('should be passed props link:string set to mock value', () => {
        ...
        expect(LeftNavButton.at(secondLeftNavButtonIndex).prop('link')).to.equal(
          leftLinksMock[secondLeftNavButtonIndex].link,
        );
      });
      ...
      it('should be passed props viewName:string set to mock value', () => {
        ...
        expect(LeftNavButton.at(secondLeftNavButtonIndex).prop('viewName')).to.equal(
          leftLinksMock[secondLeftNavButtonIndex].view,
        );
      });
      ...
      it('should be passed props onClick:function to be a function', () => {
        ...
        expect(typeof LeftNavButton.at(secondLeftNavButtonIndex).prop('onClick')).to.equal(
          'function',
        );
      });
    });
